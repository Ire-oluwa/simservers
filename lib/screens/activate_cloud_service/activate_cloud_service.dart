    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          _buildTabBar(context, _deviceNameController, _deviceKeyController, _simBalanceController, _devicePinController),
...
Widget _buildTabBar(BuildContext context, deviceNameController, deviceKeyController, simBalanceController, devicePinController) {
  return Padding(
